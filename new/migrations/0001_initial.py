    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='new.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Followwww',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='new.image')),
                ('userr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='new.profile')),
            ],
        ),
    ]
